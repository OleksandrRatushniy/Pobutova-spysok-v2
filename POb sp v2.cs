...
{
    // Створення глобального списку обладнання
    public static List<Equipment> EquipmentList;

    // Функція для збереження даних у файл без порядкового номера
    static void SaveDataToFileWithoutOrdinalNumber(string fileName)
    {
    ...
    static void Main(string[] args) // основна точка входу в програму
    {
...

        {
            ...
            Console.WriteLine("5. Операції з даними (найменше, найбільше, підсумок)");
    ...
    static void OperationsWithData()
{
    ...
    while (true)
    {
        ...
        Console.WriteLine("5. Знайти суму");
